...
EqualizerAudioProcessor::createParmeterLayout()
{
    // useing uniqe pointers the range of sound from 20.f to 20000.f hz
    // objets 
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("HighCut Freq",
        ...
        juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f), 20000.f));// for the range


    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Freq",
        "                                                   Peak Freq",
    juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f), 750.f));// for the range


        layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Gain",
        "                                                   Peak Gain",
   juce::NormalisableRange<float>(-24.f, 24.f, 0.5f, 1.f), 0.0f));// for the range

   

    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Quality",
        "                                                   Peak Quality",
        juce::NormalisableRange<float>(0.1f, 10.f, 0.05f, 1.f), 1.f));// for the range
    ...
    layout.add(std::make_unique<juce::AudioParameterChoice>("LowCut Slope", "LowCutSlope", strArray, 0));
    layout.add(std::make_unique<juce::AudioParameterChoice>("HighCut Slope", "HighCutSlope", strArray, 0));
    return layout;
}
